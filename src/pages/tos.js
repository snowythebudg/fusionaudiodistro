...
import { Theme, Link, Text, Box, Strong, Section } from "@quarkly/widgets";
import { Helmet } from "react-helmet";
import { GlobalQuarklyPageStyles } from "global-page-styles";
import { RawHtml, Override } from "@quarkly/components";
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"tos"} />
		<Helmet>
			<title>
		...
		<Section padding="80px 0 80px 0" sm-padding="60px 0 60px 0" background="--color-dark">
			...
			>
				<Text margin="0px 0px 40px 0px" color="--light" font="--base">
					Terms and Conditions for Fusion Audio Distribution
					<br />
					<br />
					<br />
					...
					{" "}(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Fusion Audio Distribution.
					<br />
					<br />
					<br />
					<br />
					...
					{" "}refers to Fusion Audio Distribution , accessible from{" "}
					<Link
						href="https://fusion.l5.ca/"
						overflow-wrap="normal"
						word-break="normal"
						white-space="normal"
						text-indent="0"
					...
					<br />
					<br />
					By email: snowythebudg@gmail.com
					<br />
					<br />
					<br />
					<br />
